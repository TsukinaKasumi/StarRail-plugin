...
import md5 from 'md5'
import mys from '../../xiaoyao-cvs-plugin/model/mys/mysTool.js'
import utils from '../../xiaoyao-cvs-plugin/model/mys/utils.js'
...
export default class MysSRApi extends MysApi {
  ...
  getUrl (type, data = {}) {
    let host, hostRecord, hostMYS
    if (['prod_gf_cn'].includes(this.server)) {
      host = 'https://api-takumi.mihoyo.com/'
      hostRecord = 'https://api-takumi-record.mihoyo.com/'
      hostMYS = 'https://api-takumi.miyoushe.com/'
    } else {
